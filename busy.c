 ...
 *
 * Compile:  gcc -g -Wall -o pth_pi_busy2 pth_pi_busy2.c timer.c -lm -lpthread
 ...
 *           This version makes sum and flag volatile.
 *
 * Notes:
 ...
 *        section.
 *    3.  This version moves the critical section outside the for loop
 */        
